...
namespace windowProject_final_
{
    partial class UserInoutForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.selectbox.Controls.Add(this.radioButton4);
            this.selectbox.Controls.Add(this.radioButton7);
            this.selectbox.Controls.Add(this.radioButton3);
            this.selectbox.Controls.Add(this.radioButton6);
            this.selectbox.Controls.Add(this.radioButton2);
            this.selectbox.Controls.Add(this.radioButton5);
            this.selectbox.Controls.Add(this.radioButton1);
            this.selectbox.Controls.Add(this.seat4);
            this.selectbox.Controls.Add(this.label1);
            this.selectbox.Controls.Add(this.seat1);
            this.selectbox.Controls.Add(this.seat8);
            this.selectbox.Controls.Add(this.seat2);
            this.selectbox.Controls.Add(this.seat5);
            this.selectbox.Controls.Add(this.seat7);
